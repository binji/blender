...
/* END BMESH ONLY */
	...
	/* 37: CD_ELEM_IDS */
	{sizeof(unsigned int), "", 0, "ElementIDs", NULL, NULL, NULL, NULL, NULL}
};
...
/* BMESH ONLY */
	...
	/* 35-37 */ "CDGridPaintMask", "CDMVertSkin", "CDElemIDs"
};
...
const CustomDataMask CD_MASK_MESH =
    ...
    CD_MASK_GRID_PAINT_MASK | CD_MASK_MVERT_SKIN | CD_MASK_ELEM_IDS;
const CustomDataMask CD_MASK_EDITMESH =
    CD_MASK_MSTICKY | CD_MASK_MDEFORMVERT | CD_MASK_MTFACE | CD_MASK_MLOOPUV |
    CD_MASK_MLOOPCOL | CD_MASK_MTEXPOLY | CD_MASK_SHAPE_KEYINDEX |
    CD_MASK_MCOL | CD_MASK_PROP_FLT | CD_MASK_PROP_INT | CD_MASK_PROP_STR |
    CD_MASK_MDISPS | CD_MASK_SHAPEKEY | CD_MASK_RECAST | CD_MASK_PAINT_MASK |
    CD_MASK_GRID_PAINT_MASK | CD_MASK_MVERT_SKIN | CD_MASK_MVERT_SKIN;
